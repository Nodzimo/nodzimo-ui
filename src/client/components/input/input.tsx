...
function Input({ className, type, ...restProps }: InputProps) {
	return (
		<InputPrimitive
			className={mcn(
				'h-8 w-full min-w-0 rounded-nui-lg border border-nui-input bg-transparent px-2.5 py-1 text-base outline-none transition-colors',
				'file:inline-flex file:h-6 file:border-0 file:bg-transparent file:font-medium file:text-nui-foreground file:text-sm',
				'placeholder:text-nui-muted-foreground',
				'focus-visible:border-nui-ring focus-visible:ring-3 focus-visible:ring-nui-ring/50',
				'disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-nui-input/50 disabled:opacity-50',
