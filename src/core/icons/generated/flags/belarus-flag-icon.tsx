...
const SvgBelarusFlagIcon = (props: JSX.IntrinsicElements['svg']) => (
	<svg
		aria-hidden='true'
		viewBox='0 0 640 480'
	...
	>
		<defs>
			<clipPath id='belarus-flag-icon_svg__a'>
				<path d='M0 0h200v608h8v284l-8 8H0z' />
			</clipPath>
		</defs>
		<path d='M0 0h640v480H0Z' fill='#ce1720' />
		<g
			clipPath='url(#belarus-flag-icon_svg__a)'
			fill='#fff'
			transform='matrix(.52885 0 0 .53333 5 0)'
		>
			<g id='belarus-flag-icon_svg__c'>
				<path
					...
					id='belarus-flag-icon_svg__b'
				/>
				<use
					href='#belarus-flag-icon_svg__b'
		...
		<path d='M110 320h530v160H110Z' fill='#007c30' />
	</svg>
)
export default SvgBelarusFlagIcon
